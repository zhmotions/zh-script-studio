...
(function () {
  ...
  function sendToTimeline(mode, overrideText) {
    ...
    var options = encodeURIComponent(JSON.stringify({ durationSeconds: dur, gapSeconds: 0, mode: mode, fontSize: 64, color: "#FFFFFF", mogrtPath: mogrtPath, animated: !!state.animatedSubs, animStyle: (state.prefs && state.prefs.aeAnimStyle) || "pop" }));
  ...
  function aeSubOptsEnc() {
    ...
    return encodeURIComponent(JSON.stringify({
      ...
      style: (state.prefs && state.prefs.aeAnimStyle) || "pop",
